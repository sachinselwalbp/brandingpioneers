          ...
          <div className="row">
            <div className="col-lg-6 align-self-center">
              ...
              <p className="txt-1 mb-16">
                Empowering Healthcare through Innovative Social Media Marketing
                - Connect, Engage, and Thrive with Branding Pioneers
              </p>
        ...
        <div className="container">
          <div className="row gy-4">
            <div className="col-lg-6 align-self-start d-flex justify-content-center">
              <div className="video-thumb">
                <a href="/">
                  <img
                    loading="lazy"
                    src={require("../../images/video_thumb.jpg")}
                    className="img-fluid"
                    alt="stact"
                  />
            ...
            <div className="col-lg-6 align-self-center">
              ...
              <p className="txt-1">
                Branding Pioneers is a dedicated team of marketing professionals
                specializing in Social Media Marketing (SMM) and Social Media
                Optimization (SMO) services for the healthcare industry. With
                our expertise, passion, and commitment to excellence, we help
                healthcare organizations establish a strong online presence,
                engage with their target audience, and drive growth.
              </p>
            </div>
            <div className="col-lg-12">
              {features_data.map((e, i) => (
                <div
                  key={i}
                  className="txt-2 color-1 fw-500 mb-8 gap-2 d-flex align-items-start"
                >
                  <div>
  ...
  const services = [
    {
      ...
      info: [
        "Our team will create a customized social media marketing strategy that aligns with your healthcare organization's objectives and goals. We'll identify the most relevant platforms, craft a content plan, and establish key performance indicators (KPIs) to track progress and measure success.",
      ],
    ...
    },
    {
      ...
      info: [
        "We produce engaging, informative, and shareable content that resonates with your target audience. Our content includes articles, infographics, videos, and images that educate, inspire, and inform while highlighting your healthcare organization's unique offerings and expertise.",
      ],
    ...
    },
    {
      ...
      info: [
        "Our team will manage your healthcare organization's social media accounts, ensuring consistent branding, prompt responses to comments and messages, and proactive audience engagement. We'll also implement growth strategies to increase your follower base and reach.",
      ],
    ...
    },
    {
      ...
      info: [
        "We'll design and manage targeted social media advertising campaigns to boost visibility, drive website traffic, and generate leads. Our team will create compelling ad creatives, select appropriate targeting options, and optimize ad spending for maximum ROI.",
      ],
    ...
    },
    {
      ...
      info: [
        "We'll provide comprehensive analytics and reports on your social media marketing performance, identifying trends, tracking KPIs, and measuring the effectiveness of our strategies. This data-driven approach allows us to refine our tactics and continuously optimize your social media presence.",
      ],
    ...
    },
    {
      ...
      info: [
        "We'll help you monitor and manage your healthcare organization's online reputation, addressing negative reviews or comments and promoting positive feedback to showcase your commitment to patient satisfaction and quality care.",
      ],
    ...
    },
    {
      ...
      info: [
        "Our team will identify, engage, and collaborate with relevant influencers and industry partners, leveraging their reach and credibility to amplify your healthcare organization's message and drive engagement with your target audience.",
      ],
    ...
    },
    {
      ...
      info: [
        "We offer social media training and consulting services to empower your healthcare organization's in-house team, providing them with the knowledge and tools necessary to manage and optimize your social media presence effectively.",
      ],
        ...
        <div className="container">
          <div className="row gy-5">
            <div className="col-lg-6 align-self-center">
              ...
              <p className="txt-1">
                Choosing us for social media marketing for healthcare can bring
                several benefits to healthcare providers, including:
              </p>
              {wcsData1.map((e, i) => (
