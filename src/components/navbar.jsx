        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mx-auto py-1 my-3 me-auto">
              ...
              <NavDropdown className="megamenu" title="Our Work">
                <Container className="mega-shadow">
                  <Row className="bg-white rounded-3 m-0 p-lg-4">
                    ...
                    <Col lg={4} className="mb-4 col_bg2">
                      <h6 className="font-weight-bold text-uppercase">
                        <NavDropdown.Item as={Link} to="/marketing-strategies" className="nav-link text-small pb-0">Marketing Strategies</NavDropdown.Item>
                      </h6>
                    ...
                    <Col lg={4} className="mb-4 col_bg3">
                      <h6 className="font-weight-bold text-uppercase">
                        <NavDropdown.Item as={Link} to="/web-services" className="nav-link text-small pb-0">Website Services</NavDropdown.Item>
                      </h6>
                      ...
                      <br />
                      <h6 className="font-weight-bold text-uppercase">
                        <NavDropdown.Item as={Link} to="/content" className="nav-link text-small pb-0">Content</NavDropdown.Item>
                      </h6>
              ...
              <Nav.Link as={Link} className="font-weight-bold" to="/blog">Blog</Nav.Link>
            </Nav>
          </Navbar.Collapse>
